...
import { Mail, Lock, Languages, ArrowRight, Loader2, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 font-light">Enter your credentials to access your dashboard</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-12 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all font-light"
                  placeholder="••••••••"
                  required
                />
                <button
